...
References do not provide universal cutoff values. QC cutoffs remain experiment-specific decisions documented in `config/datasets/<dataset_version>/cohorts/<cohort_id>/qc_thresholds.csv`.
